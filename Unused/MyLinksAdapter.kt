...
import com.segihovav.mylinks_android.MyLinksAdapter.MyViewHolder
import java.util.*

class MyLinksAdapter(private val names: List<String>, private val MyLinksTypeNames: MutableList<String>) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (position<MyLinksTypeNames.size)
             holder.typeInfo.text=MyLinksTypeNames[position]
    }
